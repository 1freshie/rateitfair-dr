...
export default function NavbarNew() {
  return (
    <nav className="sticky top-0 h-24 lg:h-16 w-full bg-background--white flex flex-col gap-y-3 md:gap-y-0 md:flex-row justify-center md:justify-between items-center tracking-wide">
      <Link
        href="/"
