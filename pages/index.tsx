...
export default function HomePage() {
  return (
    <>
      ...
      <main className="w-full h-full self-center flex flex-col md:flex-row items-center justify-between lg:gap-8">
        <div className="flex flex-col items-start justify-center w-full md:w-1/2 gap-y-8 text-center md:text-left">
          ...
          <p className="paragraph">
            ...
            ones you have experience with and share your opinion! Be a part of
            them improving!
          </p>
        </div>
